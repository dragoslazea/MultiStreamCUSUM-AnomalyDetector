...
entity testbench_multi_stream_cusum_2_sensors is
end testbench_multi_stream_cusum_2_sensors;

architecture tb of testbench_multi_stream_cusum_2_sensors is
...
--        file sensors_data_s2 : text open read_mode is "04-12-22_measurements_bin_short_s2.csv";
        file sensors_data_s2 : text open read_mode is "04-12-22_measurements_bin_short_test.csv";
    ...
    begin
        ...
        if abnormal_valid = '1' then
            if abnormal(32 downto 1) = 0 then
