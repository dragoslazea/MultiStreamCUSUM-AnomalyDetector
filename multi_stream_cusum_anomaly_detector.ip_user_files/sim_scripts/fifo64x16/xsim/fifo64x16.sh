...
#
# Generated by Vivado on Wed Oct 11 12:52:23 +0300 2023
# IP Build 1755317 on Mon Jan 23 20:30:07 MST 2017 
#
# usage: fifo64x16.sh [-help]
# usage: fifo64x16.sh [-lib_map_path]
# usage: fifo64x16.sh [-noclean_files]
# usage: fifo64x16.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "fifo64x16.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L axis_infrastructure_v1_1_0 -L fifo_generator_v13_1_3 -L axis_data_fifo_v1_1_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo64x16 xil_defaultlib.fifo64x16 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim fifo64x16 -key {Behavioral:sim_1:Functional:fifo64x16} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fifo64x16.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo64x16.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fifo64x16.sh -help\" for more information)\n"
    exit 1
  fi
