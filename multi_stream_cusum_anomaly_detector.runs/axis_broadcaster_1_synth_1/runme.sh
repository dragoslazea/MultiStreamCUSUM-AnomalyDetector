...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/axis_broadcaster_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_broadcaster_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_broadcaster_1.tcl
