...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_multi_stream_cusum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_multi_stream_cusum.tcl -notrace
