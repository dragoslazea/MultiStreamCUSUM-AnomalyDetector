...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/fifo32x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo32x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo32x16.tcl
