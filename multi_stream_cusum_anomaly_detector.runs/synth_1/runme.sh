...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_multi_stream_cusum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_multi_stream_cusum.tcl
