...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/fp_greater_than_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_greater_than.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_greater_than.tcl
