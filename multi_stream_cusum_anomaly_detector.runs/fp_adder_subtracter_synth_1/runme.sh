...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/fp_adder_subtracter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_adder_subtracter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_adder_subtracter.tcl
