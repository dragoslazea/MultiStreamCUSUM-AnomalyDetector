...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/axis_combiner_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_combiner_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_combiner_0.tcl
