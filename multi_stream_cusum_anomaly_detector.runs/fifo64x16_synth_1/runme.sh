...
HD_PWD='C:/IVA/Research/multi_stream_cusum_anomaly_detector/multi_stream_cusum_anomaly_detector.runs/fifo64x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo64x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo64x16.tcl
